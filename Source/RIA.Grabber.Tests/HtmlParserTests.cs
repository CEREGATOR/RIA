namespace RIA.Grabber.Tests
{
    ...
    public class HtmlParserTests
    {
        ...
        {
            _html = File.ReadAllText(@"D:\C#\1.html");
        }
        ...
        public void ParsePage_ReturnsExpectedModel()
        {
            ...
            {
                new LinkWithDescription {Url="http://ria.ru/person_Aleksejj_Navalnyjj/",Description="Алексею Навальному"},
            ...
            for (var i = 0; i < expImgLinks.Count; i++)
            {
